...
import { Briefcase, Mail, Chrome, Github, AlertCircle, UserPlus } from 'lucide-react'
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="signup" className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <Chrome className="h-5 w-5 mr-3 text-red-500" />
                    {loadingProvider === "google" ? "Signing up..." : "Sign up with Google"}
                  </Button>
                  ...
                  >
                    <Github className="h-5 w-5 mr-3" />
                    {loadingProvider === "github" ? "Signing up..." : "Sign up with GitHub"}
                  </Button>
                </div>
